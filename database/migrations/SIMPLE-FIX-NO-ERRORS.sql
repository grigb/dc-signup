-- SIMPLE FIX FOR ADMIN DASHBOARD - NO ERRORS VERSION
-- This avoids the boolean type error by simplifying the verification
-- Date: 2025-07-06 17:40
-- CRITICAL: Run this to fix all database permission issues
...
DROP POLICY IF EXISTS "Admins can create admin_users" ON admin_users;
...
-- Simple success notification (no variables to avoid type errors)
